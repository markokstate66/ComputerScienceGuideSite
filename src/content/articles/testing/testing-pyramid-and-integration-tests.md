...
:::note
Every program on this page was run with the .NET 10 SDK (10.0.401) on Windows 11, x64, resolving `#:package xunit.v3@1.*` to 1.1.0 and `#:package Microsoft.Data.Sqlite@9.*` to 9.0.20. Both packages are ordinary NuGet references in a file-based program, the same mechanism used throughout this pillar ([File-based apps](https://learn.microsoft.com/en-us/dotnet/core/sdk/file-based-apps)).
:::
