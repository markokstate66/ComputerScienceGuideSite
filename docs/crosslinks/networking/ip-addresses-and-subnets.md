...
The two forward-references already waiting in `docs/crosslinks/networking/how-the-internet-works.md` ("IP addresses" and "network address port translation", both pointing here) can now be wired, since this article's route exists.
